...
Es por eso que este trabajo se enfoca en cómo procesar los textos para obtener las reglas necesarias para determinar si un comentario es o no positivo, y realizar una aplicación para comprobar su eficacia con un caso concreto. El proyecto se utilizará para participar en el concurso de \nombre{kaggle:} ``Sentiment Analysis on Movie Reviews''.\footnote{\url{https://www.kaggle.com/c/sentiment-analysis-on-movie-reviews}}
