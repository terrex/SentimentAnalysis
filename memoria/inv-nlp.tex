...
\begin{description}
\item[continous bag-of-words] (CBOW)\index{CBOW} Se considera la palabra y un contexto de $n-1$ palabras posteriores consecutivas, que se tratará como un conjunto (bolsa de palabras), sin tener en cuenta su orden de aparición en la frase.
