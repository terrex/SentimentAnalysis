...
Para ello es necesario construirse una tabla que establezca el mapping \citep{Perkins2014}. Como ejemplo, véase una tabla no exhaustiva en la \autoref{tbl:contracciones}.
...
\end{tabular}
\caption{Sustitución sintetizada mediante expresiones regulares}
