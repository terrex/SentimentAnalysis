...
La tokenización en su sentido más amplio y general es el procedimiento del análisis léxico para reconocer lexemas del flujo de entrada con la que se obtiene un flujo de salida compuesto por tokens \citep[p.27]{jimenez2004}.
...
Pongamos algunos ejemplos de tokens, patrones y lexemas:
\nopagebreak
\begin{center}
\begin{tabular}{|l|l|l|}
\hline
