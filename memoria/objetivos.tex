...
\item Estudiar algoritmos de aprendizaje automático (ML)\index{ML} aplicado a tareas de procesamiento de lenguaje natural (NLP).\index{NLP}
\item Desarrollar una biblioteca unificada de NLP y ML para el análisis del sentimiento o polaridad de opiniones.
\item Desarrollar un asistente con una Interfaz Gráfica de Usuario (IGU ó GUI)\index{IGU}\index{GUI} para usar en el aula.
\end{itemize}
