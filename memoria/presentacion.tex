...
citestyle=authoryear-comp,doi=false,url=false,isbn=false,backend=biber,dashed=no]{biblatex}
...
\note[item]<1>{... 1.2 usando corpus, 1.3 usando datasets....}
}
...
\setsansfont[Scale=0.7,Mapping=tex-text]{Gill Sans}
