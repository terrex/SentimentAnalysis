...
\setbeamercolor{note page}{bg=white!95!black, fg=black}
...
\note[item]<1>{Luego pasamos a dar un repaso de los tipos de aprendizaje automático de inteligencia artificial: supervisado, no supervisado y semi-supervisado; enfocados a resolver el problema de clasificación automática de muestras.}
...
\note[item]<1>{Las conclusiones son que se han conseguido los objetivos marcados, el estudio de NLP y ML y la manera de combinarlos.}
