...
\note[item]<1>{Para producir este dataset se extrae el texto de las críticas de la página web de Rotten Tomatoes, se parsean en unidades más pequeñas y varios voluntarios se encargan de clasificar el sentimiento de cada frase.}
